# Virus_Simulation
  ...
  The simulation will also create a graph with the data inputted by the user that represents the infected and recovered people. The x-value for the graph is the time and y value will either be recovered or infected. Since there will be two lines showing the infected and recovered people. 
